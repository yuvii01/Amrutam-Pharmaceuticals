...
Meet Our Ayurvedic Experts
    ...
    <div className='hidden mx-[50px] md:mx-[100px] lg:mx-0 overflow-x-scroll   lg:grid grid-cols-3 gap-10'>


<div className='grow shrink-0 w-full rounded-3xl pt-10 h-auto text-center overflow-hidden  bg-[#FFF7E2]   '>
    <div className='rounded lg:px-[150px]   relative  '>
    <img src="/images/face.png" alt="" className='scale-90' />
<div className='absolute bottom-1 left-[200px] px-1 flex items-center gap-3 bg-black text-white w-[60px] font-bold h-[20px] rounded-full'>
...
<div className='w-full  grow shrink-0 rounded-3xl pt-10 h-auto text-center overflow-hidden  bg-[#FFF7E2]   '>
    <div className='rounded px-[150px]  relative  '>
    <img src="/images/face.png" alt="" className='scale-90' />
<div className='absolute bottom-1 left-[200px] px-1 flex items-center gap-3 bg-black text-white w-[60px] font-bold h-[20px] rounded-full'>
4.5  <IoIosStar className='text-[#FFD700]' />
</div>
...
<Slider {...settings}>
<div className='grow shrink-0 w-full rounded-3xl pt-10 h-auto text-center overflow-hidden  bg-[#FFF7E2]   '>
    <div className='rounded lg:px-[100px] ps-[170px]  relative  '>
    <img src="/images/face.png" alt="" className='scale-90' />
<div className='absolute bottom-1 left-[220px] px-1 flex items-center gap-3 bg-black text-white w-[60px] font-bold h-[20px] rounded-full'>
4.5  <IoIosStar className='text-[#FFD700]' />
</div>
    </div>
...
<div className='flex gap-2 mx-auto px-[70px] py-2   '>
<FaRedhat className='text-xl' /> 25 years of experience
</div>
...
<div className='w-full grow shrink-0 rounded-3xl pt-10 h-auto text-center overflow-hidden  bg-[#FFF7E2]   '>
    <div className='rounded px-[170px]  relative  '>
    <img src="/images/face.png" alt="" className='scale-90' />
<div className='absolute bottom-1 left-[220px] px-1 flex items-center gap-3 bg-black text-white w-[60px] font-bold h-[20px] rounded-full'>
4.5  <IoIosStar className='text-[#FFD700]' />
</div>
